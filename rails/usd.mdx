...
<Warning>
  Enhanced Verification is part of a pilot program. Do not enable payouts for an
  Enhanced Verification business until enhanced KYB is complete and the business
  has an active KYB status.
</Warning>

<Info>
  For pilot rules, see the [Enhanced Verification guide](/compliance/enhanced-verification).
</Info>
