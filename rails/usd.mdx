...
USD payouts are available for the following Enhanced Verification countries through enhanced KYB:
...
<Warning>
  Enhanced Verification USD payouts are part of a pilot program. Do not enable
  payouts for an Enhanced Verification business until enhanced KYB is complete
  and the business has an active KYB status.
</Warning>

<Info>
  For implementation details, see the [Enhanced Verification guide](/compliance/enhanced-verification).
</Info>
