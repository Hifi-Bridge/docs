...
USD payouts are available for the following Enhanced Due Diligence (EDD) countries through enhanced KYB:
...
<Warning>
  EDD USD payouts are part of a pilot program. Do not enable payouts for an EDD
  business until enhanced KYB is complete and the business has an active KYB
  status.
</Warning>

<Info>
  For implementation details, see the [Enhanced Due Diligence guide](/compliance/enhanced-due-diligence).
</Info>
...
<Note>
  For EDD businesses, provide every UBO with 10%
  ...
  verification. See the [Enhanced Due Diligence guide](/compliance/enhanced-due-diligence)
