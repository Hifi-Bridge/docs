...
USD payouts are available for the following high risk countries through enhanced KYB:
...
<Warning>
  High-risk-country USD payouts are part of a pilot program. Do not enable
  payouts for a high-risk-country business until enhanced KYB is complete and
  the business has an active KYB status.
</Warning>

<Info>
  For implementation details, see the [High Risk Countries guide](/guides/high-risk-countries).
</Info>
...
<Note>
  For businesses from high risk countries, provide every UBO with 10%
  ...
  verification. See the [High Risk Countries guide](/guides/high-risk-countries)
