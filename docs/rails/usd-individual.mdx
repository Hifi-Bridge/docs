...
<Info>
  Proof of Address (PoA) is required for all non-U.S. users or non-Canadian users, as well as for U.S. users or Canadian users who submit identity documents that do not clearly display an address. In addition, U.S. users flagged by our internal verification system may also be subject to PoA collection. \
  \
