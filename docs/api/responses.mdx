...
```bash
curl -X POST "https://production.hifi.com/v2/users/{userId}/kyc" \
...
```bash
curl -X GET "https://production.hifi.com/v2/users/{userId}/kyc?expand[]=ultimateBeneficialOwners&expand[]=documents&expand[]=ultimateBeneficialOwners.documents" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X POST "https://production.hifi.com/v2/users/{userId}/kyc/ultimateBeneficialOwners" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "firstName": "John",
...
```bash
curl -X PUT "https://production.hifi.com/v2/users/{userId}/kyc/ultimateBeneficialOwners/{uboId}" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "phone": "+1234567890"
...
```bash
curl -X GET "https://production.hifi.com/v2/users/{userId}/kyc/ultimateBeneficialOwners/{uboId}?expand[]=documents" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X GET "https://production.hifi.com/v2/users/{userId}/kyc/ultimateBeneficialOwners?expand[]=documents" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X GET "https://production.hifi.com/v2/users/{userId}/kyc?expand[]=ultimateBeneficialOwners&expand[]=documents" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl -X GET "https://production.hifi.com/v2/users/{userId}/kyc?expand[]=ultimateBeneficialOwners.documents" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
