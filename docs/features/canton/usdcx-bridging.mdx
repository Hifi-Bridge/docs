...
For more details, please refer to [Accept Transfer Offer**.**](/docs/features/canton/transfer-offer)

## Burn USDCx on Canton and Receive on Ethereum

To release USDC back on Ethereum, simply use the [Create Bridge](https://docs.hifibridge.com/api-reference/bridge/create-a-bridge) endpoint to initiate a cross-chain transfer from Canton to Ethereum.
...
- [Transfer Offers](/features/batch-transfers) - Canton Transfer Offers
