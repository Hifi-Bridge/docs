...
- [Retrieve Offramp Rate](/api-reference/offramp/retrieve-offramp-rate) - For stablecoin to fiat conversions
- [Retrieve Onramp Rate](/api-reference/onramp/retrieve-onramp-rate) - For fiat to stablecoin conversions
