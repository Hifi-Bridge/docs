...
- [Retrieve Offramp Rate](https://docs.hifibridge.com/api-reference/offramp/retrieve-an-offramp-rate) - For stablecoin to fiat conversions
- [Retrieve Onramp Rate](https://docs.hifibridge.com/api-reference/onramp/retrieve-an-onramp-rate) - For fiat to stablecoin conversions
...
| **toCurrency**   | Yes      | `usd`, `usd-hka`, `usd-chn`, `eur`, `brl`, `mxn`, `ars`, `cop`, `ugx`, `ngn`, `kes`, `xof`, `rwf`, `tzs`, `zmw`, `mwk`, `xaf`, `bwp`, `ghs`, `zar`, `hkd`, `cny` |
