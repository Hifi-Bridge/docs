...
- [Retrieve Offramp Rate](https://docs.hifibridge.com/api-reference/offramp/retrieve-offramp-rate) - For stablecoin to fiat conversions
- [Retrieve Onramp Rate](https://docs.hifibridge.com/api-reference/onramp/retrieve-onramp-rate) - For fiat to stablecoin conversions
...
<ResponseField name="conversionRate" type="string">
  Estimated conversion rate from the source currency to the destination
