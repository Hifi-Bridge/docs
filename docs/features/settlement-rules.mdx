...
<Info>
For detailed field documentation, see the [Create Settlement Rule](https://docs.hifibridge.com/api-reference/virtual-account/create-settlement-rule) API reference.
</Info>
