...
<Warning>
  We only support 🇺🇸 USD Virtual Accounts for automatic onramps. For other currencies, use our [Onramp API](/docs/transfers/onramps/).
</Warning>
...
<Card title="Settlement Rules" icon="calculator" href="/docs/transfers/features/settlement-rules">
...
<CardGroup cols={2}>
  <Card title="Update Account" icon="pen-to-square" href="api/virtual-account/update-a-virtual-account">
    
  </Card>
  <Card title="Deactivate Account" icon="circle-stop" href="/api/virtual-account/deactivate-a-virtual-account">
...
<Card title="Simulate Deposit" icon="code" href="/api/virtual-account/simulate-a-deposit-to-a-virtual-account">
