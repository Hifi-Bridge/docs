...
<Card title="Settlement Rules" icon="gear" href="/docs/transfers/virtual-accounts/settlement-rules">
  Learn how to configure fee calculations and distribution
</Card>

## Try it out

<Card title="Convert USD to USDC" icon="code" href="/guides/convert/usd-usdc">
