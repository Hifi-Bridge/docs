...
In this guide, you'll learn how to use the **HIFI Sandbox API** to simulate money movement between fiat and stablecoins. You'll create users, complete KYC, set up accounts, and execute a complete transfer flow from fiat to stablecoins and back.
...
- ✅ KYC applications are automatically approved
