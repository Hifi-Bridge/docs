...
- **User B** (Jack Doe) - A pre-existing test user in sandbox (`30669fcc-b15e-4137-b4fc-9e8f7f659a87`)
...
<Note>
  **User B in Sandbox:** User B is a pre-configured test user that exists in the
  sandbox environment for demonstration purposes. In production, you would
  create User B following the same steps as User A.
</Note>
...
You've successfully completed the HIFI API quickstart! You now know how to:
...
- **[Rails Overview](/docs/compliance/rails)** - Learn about additional currency rails and their requirements
- **[Error Handling](/docs/api/errors)** - Understand error codes and how to handle failures gracefully
