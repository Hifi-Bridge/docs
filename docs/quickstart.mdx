...
<ResponseField
  name="required"
  description="Lists all the mandatory KYC information required for the **USD** rail KYC application."
/>
<ResponseField
  name="optional"
  description="Contains any additional KYC information that is not mandatory but may be supplied, for example, fields that might be needed for other rails such as **USD_EURO**."
/>
<ResponseField
  name="invalid"
  description="Shows any KYC fields or document groups that are missing or invalid and must be corrected before the user’s KYC application for the **USD** rail can proceed."
/>
