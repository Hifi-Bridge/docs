...
> 📘 The Submit KYC endpoint submits the existing KYC information stored for the user to the specified rail. If you want to submit any new KYC data that the user doesn't currently hold, you must first update the user's KYC information using the [Update KYC](https://docs.hifibridge.com/v2/reference/post_v2-users-userid-kyc) endpoint before calling [Submit KYC](https://docs.hifibridge.com/v2/reference/post_v2-users-userid-kyc-submissions).
