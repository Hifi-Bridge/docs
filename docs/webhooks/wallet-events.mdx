...
The data object is expected to have the same structure as the response from the [Retrieve a crypto transfer endpoint](/api-reference/wallet/retrieve-a-crypto-transfer)
...
The data object is expected to have the same structure as the response from the [Retrieve a bridging request endpoint](/api-reference/wallet/retrieve-a-bridging-request)
