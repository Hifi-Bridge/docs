...
The data object is expected to have the same structure as the response from the [Get KYC Data endpoint](/api-reference/kyc/get-kyc-data).
...
The data object is expected to have the same structure as the response from the [Get KYC Status endpoint](/api-reference/kyc/get-kyc-status).
