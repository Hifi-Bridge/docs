...
The data object is expected to have the same structure as the response from the [Retrieve an offramp endpoint](/api-reference/offramp/retrieve-an-offramp).
