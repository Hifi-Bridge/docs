...
<Warning>
  ...
  still block approval. For example, banking partners like Cross River may
  perform PEP (Politically Exposed Person) screening that can prevent sandbox
  users from unlocking rails even in the test environment.
</Warning>
