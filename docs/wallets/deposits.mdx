...
| `status`        | string | ❌       | Deposit status              | `CONFIRMED`, `COMPLETED`                |
| `createdAfter`  | date   | ❌       | Filter deposits after date  | `2024-01-01`                            |
| `createdBefore` | date   | ❌       | Filter deposits before date | `2024-12-31`                            |
| `limit`         | string | ❌       | Number of results (1-100)   | `10` (default), `50`                    |
| `minAmount`     | number | ❌       | Minimum deposit amount      | `0.01`                                  |
