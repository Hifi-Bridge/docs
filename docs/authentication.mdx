...
<Note>
  Before you can create API keys, you'll need access to the HIFI Dashboard.
  [Schedule a call with our team](https://dashboard.hifi.com/request-access) to
  get access.
</Note>
...
1. Log in to the [HIFI Dashboard](https://dashboard.hifi.com)
2. Navigate to **Developer** → **API Keys** or go directly to [https://dashboard.hifi.com/developer/apiKeys](https://dashboard.hifi.com/developer/apiKeys)
