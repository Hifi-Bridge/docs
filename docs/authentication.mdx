...
<Card title="Request access" href="https://dashboard.hifi.com/request-access">
...
2. Navigate to **Developer** → **API Keys**  
   Or go directly to: [dashboard.hifi.com/developer/apiKeys](https://dashboard.hifi.com/developer/apiKeys)
