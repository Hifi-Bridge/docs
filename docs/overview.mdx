...
HIFI is a developer platform for money. We provide APIs and tools for financial institutions and startups to program and move money using stablecoins and global payment rails.

## Getting Started

First, you need access to our Developer Dashboard. On the Dashboard, you can try out the product in sandbox or get API keys for integration. Schedule a call with our team to discuss your use case.
