...
- **Profile** – Contains the base information for an individual or business user — for example, first name, last name, business name, etc.
- **Associated Party** – Contains the information for either the UBOs of the business or persons with significant control of the business
- **Documentation** – Files for individuals, businesses, and associated parties — for example, physical ID, utility bills, formation documents, etc.
- **Questionnaire** – A list of questions that helps our compliance team evaluate the expected use cases and volume
...
- KYC requirements
- KYB requirements
- Associated Party requirements (part of the KYB application)
...
- KYC Requirements (detailed field list)
- KYB Requirements (detailed field list)
- Webhooks
- API Reference: Compliance endpoints