...
1. **Generate Terms of Service link** - User must review and accept HIFI's [Terms of Service](/terms-of-service)
...
1. **Upload compliance information** – Submit the user's KYC/KYB details via PATCH `/v3/users/:user_id/compliance/profile`. See the <u>Compliance Information</u> for more details.
