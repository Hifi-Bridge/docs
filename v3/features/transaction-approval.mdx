...
<Steps>
  ...
  <Step title="Execution or cancellation">
    If approved, transfer proceeds (bridge and offramp move to quoting; onchain and batch transfers execute directly). If rejected, transfer is cancelled.
  </Step>
</Steps>
...
| `APPROVED` | Approved - the underlying transfer proceeds. |
| `REJECTED` | Rejected - the underlying transfer is cancelled. |
