...
<Info>
  Looking to charge fees on Offramps instead? See [Developer Fees](https://docs.hifi.com/v3/features/developer-fee).
</Info>
...
```shell
curl -X POST https://sandbox.hifi.com/v3/virtual-accounts/va_HtgURm58uWMF0EzmG8DAl/settlement-rules \
  -H "Idempotency-Key: <unique-key>" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -d '{
    "settlementRuleId": "sr_15c786fbde7a520ca4b3f312",
  }'
```
...
```shell
curl -X DELETE https://sandbox.hifi.com/v3/virtual-accounts/va_HtgURm58uWMF0EzmG8DAl/settlement-rules \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
- [Developer Fees](https://docs.hifi.com/v3/features/developer-fee) - Fee calculation for Offramp transactions