...
<Info>
  HIFI does not support businesses or activities related to the industries below. You will not be able to create Users or transfers for these business types.
</Info>
...
<Info>
  These industries require Enhanced Due Diligence (EDD) and Compliance approval before being able to use HIFI services.
</Info>
