...
<Note>
  For companies registered in [high-risk countries](/v3/compliance/regions#high-risk-regions), we require all UBOs with 10% or more ownership to be added as associated parties prior to KYB submission.
</Note>
...
<Steps>
  <Step title="Add the associated party">
    ...
    **Request**
    ...
    ```shell
    curl -X POST "https://sandbox.hifi.com/v3/compliance/associated-parties" \
