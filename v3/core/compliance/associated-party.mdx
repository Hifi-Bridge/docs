...
<Note>
  For company registered in high risk countries, we require all UBOs with 10% ownership or above must be added as associated party prior to KYB submission.
</Note>
