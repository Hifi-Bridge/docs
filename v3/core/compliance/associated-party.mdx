...
<Note>
  For companies registered in [high-risk countries](/v3/compliance/regions), we require all UBOs with 10% or more ownership to be added as associated parties prior to KYB submission.
</Note>
