...
Different information is required for verification, including both non-documentary and documentary checks. For business users, associated parties, and ultimate beneficial owners (UBOs), information is required in addition to the company information.
