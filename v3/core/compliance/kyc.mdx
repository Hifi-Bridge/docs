...
| `physicalAddress` | Residential address (line 1, city, state, postal code, country) | Yes |
...
- [Virtual Accounts](https://docs.hifi.com/v3/core/orchestration/virtual-accounts) - Set up fiat deposit accounts
