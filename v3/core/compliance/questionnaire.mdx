...
{/* TODO: If these fields have fixed enum values (e.g. employmentStatus,
  sourceOfFunds, volume/count ranges), list them here or link to the API
  Reference where they're enumerated */}
...
<Tabs>
  ...
  <Tab title="Business">
    ...
    **Response**
    ...
    {/* TODO: Replace with a real sandbox request/response pair — the
  business response shape is inferred from the individual one */}
  </Tab>
</Tabs>
