...
7. **Resolve RFIs** – Submit response to HIFI-hosted link, or via POST `/v3/rfis/:rfi_id/submissions`. See [Requests for Information](/v3/core/compliance/rfi)
...
- [Associated Parties](/v3/core/compliance/associated-party) - UBO and control person requirements