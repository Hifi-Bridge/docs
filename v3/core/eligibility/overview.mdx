...
- **Filters are optional**: omit every filter to see everything currently eligible; add `fiatCurrency`, `fiatCountry`, `transferType`, etc, to narrow down to one specific combination.
