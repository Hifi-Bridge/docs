...
This differs from HIFI Wallets on other chains, where an incoming transfer just shows up as a [deposit](https://docs.hifi.com/v3/core/wallets/hifi-wallet#retrieve-a-wallet%E2%80%99s-balance) with nothing to action.
...
```shell
curl https://sandbox.hifi.com/v3/wallets/wlt_a1b2c3/offers \
...
```shell
curl -X POST https://sandbox.hifi.com/v3/wallets/wlt_a1b2c3/offers/ofr_3b6f7b9a1f3a/accept \
