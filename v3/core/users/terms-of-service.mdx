...
<Steps>
  ...
  <Step title="Accept ToS Link:">
    Accept the ToS Link with the sign agreement id

    **Request:**

    ```shellscript
    curl -X POST "https://sandbox.hifi.com/v3/tos-link/48867c6c-1748-49a9-8e64-ed48f6815213/accept" \
      -H "Authorization: Bearer YOUR_API_KEY" \
      -H "Content-Type: application/json" \
    ```
...
<Steps>
  ...
  <Step title="Share the ToS Link with your user">
    ...
    <Frame>
      ![Screenshot 2026 07 13 At 10 41 39 AM](/images/Screenshot-2026-07-13-at-10.41.39-AM.png "Screenshot 2026 07 13 At 10 41 39 AM")
    </Frame>
  </Step>
  <Step title="Wait for webhook message">
    After the ToS Link is accepted, HIFI will send out a webhook message to the registered URL.
...
4. **Include redirect URL**: Include `redirectUrl` when you want to send the user to a different page once the terms of service is accepted.
