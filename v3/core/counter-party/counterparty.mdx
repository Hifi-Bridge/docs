...
Check the counterparty's status before adding external accounts, cards, or wallets. Get the status via Get Counterparty, or subscribe for counterparty status updates.
