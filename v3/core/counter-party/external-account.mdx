...
```shell
curl -X POST https://sandbox.hifi.com/v3/external-accounts \
...
```shell
curl -X DELETE https://sandbox.hifi.com/v3/external-accounts/extacct_QW1e2r3t4y \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```shell
curl https://sandbox.hifi.com/v3/external-accounts?counterPartyId=cpty_a1b2c3&limit=10&transferType=WIRE&currency=USD \
  -H "Authorization: Bearer YOUR_API_KEY"
```
