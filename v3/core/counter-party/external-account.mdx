...
<Note>
  For some corridors we may require additional information for the counterparty - for example, MXN and BRL, which require the counterparty's `taxId`. Checkout [Account Information](/v3/docs/references/account-information) for details.
</Note>
