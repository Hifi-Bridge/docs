...
An External Card is a debit, prepaid or credit card belonging to a [Counterparty](/v3/core/counter-party/counter-party), used as the destination for a push style card payout.
...
- [Counterparty](/v3/core/counter-party/counter-party) - Create and manage recipients/payers
