...
Some destinations require a `purposeOfPayment` describing why the payment is being made - for example, it's required for SWIFT transfers and other local payouts outside of the U.S.
...
<AccordionGroup>
  <Accordion title="Transfer approval">
    ...
    Check out [Transfer Approval](https://docs.hifi.com/v3/features/transaction-approval) for more details.
  </Accordion>
