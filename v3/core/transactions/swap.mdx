...
The source and destination chains are derived from the source wallet and destination wallet.
...
| `QUOTE_FAILED` | No route/liquidity for the pair, or insufficient balance at time of acceptance. | Yes |
