...
```text
https://sandbox.hifibridge.com/v3/
```
...
- **Virtual Account Deposits** - Use simulate deposit endpoint to mimic bank deposits
...
<Warning>
  Please do not send real funds to testnet wallets. HIFI is not responsible for any funds lost in this situation.
</Warning>
