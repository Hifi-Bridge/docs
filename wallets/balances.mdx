---
title: "Balances"
description: "You can get a real-time view of funds that can be spent or withdrawn from a Wallet. Balances are separated by currency and network. For example, a wallet may hold USDC on Ethereum and USDC on Solana."
---


<Card icon="coins" title="Supported Currencies" href="/docs/references/currencies">
