...
- **WALLET.OFFER.{status}**: Transfer offer status updates

## WALLET.TRANSFER

The data object is expected to have the same structure as the response from the [Retrieve a crypto transfer endpoint](https://docs.hifibridge.com/api-reference/wallet/retrieve-a-crypto-transfer)
...
The data object is expected to have the same structure as the response from the [Retrieve a bridging request endpoint](https://docs.hifibridge.com/api-reference/wallet/retrieve-a-bridging-request)
...
Transfer offer events are sent when the status of a transfer offer changes. The event format follows the pattern `WALLET.OFFER.{status}`.

### Event Types

| Event Type | Description |
|------------|-------------|
| `WALLET.OFFER.RECEIVED` | Transfer offer has been received |
| `WALLET.OFFER.PENDING` | Transfer offer is pending action |
| `WALLET.OFFER.ACCEPTED` | Transfer offer has been accepted |
| `WALLET.OFFER.REJECTED` | Transfer offer has been rejected |
