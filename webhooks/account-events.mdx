...
The data object is expected to have the same structure as the response from the [Retrieve an account endpoint](https://docs.hifi.com/api-reference/account/retrieve-an-account).
...
The data object is expected to have the same structure as the response from the [Retrieve a virtual account endpoint](https://docs.hifi.com/api-reference/virtual-account/retrieve-a-virtual-account).
