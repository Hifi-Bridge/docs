...
The data object is expected to have the same structure as the response from the [Get User endpoint](https://docs.hifi.com/api-reference/user/retrieve-a-user).
