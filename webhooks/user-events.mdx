---
title: "User Events"
description: "You can expect to receive webhook events whenever you successfully create or update a user."
---
...
The data object is expected to have the same structure as the response from the [Get User endpoint](https://docs.hifibridge.com/api-reference/user/retrieve-a-user).
