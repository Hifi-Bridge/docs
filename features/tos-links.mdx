...
<Steps>
  <Step title="Generate ToS link">
    Create a ToS link using the [Generate ToS Link](https://docs.hifibridge.com/api-reference/tos-link/generate-tos-link) endpoint.
...
- [API Reference](https://docs.hifibridge.com/api-reference/tos-link/generate-tos-link) - Complete endpoint documentation
