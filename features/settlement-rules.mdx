...
Create a settlement rule using the [Create Settlement Rule](https://docs.hifi.com/api-reference/virtual-account/create-settlement-rule) endpoint.
...
<Info>
  ...
  Rule](https://docs.hifi.com/api-reference/virtual-account/create-settlement-rule)
  API reference.
</Info>
...
After creating a settlement rule, associate it with a specific user's virtual account using the [Apply Settlement Rule](https://docs.hifi.com/api-reference/virtual-account/apply-settlement-rule) endpoint.
...
- [API Reference](https://docs.hifi.com/api-reference/virtual-account/create-settlement-rule) - Complete endpoint documentation
