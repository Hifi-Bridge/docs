...
The USD rail supports the following Enhanced Due Diligence (EDD) countries for business users through enhanced KYB:
...
<Warning>
  EDD coverage is part of a pilot program. Business users require enhanced KYB
  before USD payouts can be enabled. See the [Enhanced Due Diligence
  guide](/compliance/enhanced-due-diligence) for UBO verification and review-limit
  requirements.
</Warning>
