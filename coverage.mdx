...
The USD rail supports the following high risk countries for business users through enhanced KYB:
...
<Warning>
  High-risk-country coverage is part of a pilot program. Business users require
  enhanced KYB before USD payouts can be enabled. See the [High Risk Countries
  guide](/guides/high-risk-countries) for UBO verification and review-limit
  requirements.
</Warning>
