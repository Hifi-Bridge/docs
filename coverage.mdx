...
The USD rail supports the following Enhanced Verification countries for business users through enhanced KYB:
...
<Warning>
  Enhanced Verification coverage is part of a pilot program. Business users
  require enhanced KYB before USD payouts can be enabled. See the [Enhanced
  Verification guide](/compliance/enhanced-verification) for UBO verification
  and review-limit requirements.
</Warning>
