...
Business users incorporated in India, Nigeria, Panama, the Philippines, Saudi Arabia, and Vietnam can be enabled for USD virtual accounts after required UBO identity and liveness checks are complete.

<Info>
  This is virtual-account eligibility, not expanded USD payout coverage. See
  [Liveness Checks](/compliance/liveness-checks) for the 10% UBO threshold and
