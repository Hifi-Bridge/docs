---
title: "Documents"
description: "Documents enable programmatic upload and management of KYC verification documents. Upload identity documents, proof of address, and business documents through the Documents API."
...
<Steps>
  <Step title="Upload file">
    First, upload the document file using the [Upload File](https://docs.hifibridge.com/api-reference/files/upload-file) endpoint to get a file ID.
  </Step>
  <Step title="Add document">
    Then, associate the file with the user by calling [Add Documents](https://docs.hifibridge.com/api-reference/kyc/add-documents) with the file ID, type, subtype, and issued country.
  </Step>
...
Upload the document file using the [Upload File](https://docs.hifibridge.com/api-reference/files/upload-file) endpoint.
...
Associate the uploaded file with the user using the [Add Documents](https://docs.hifibridge.com/api-reference/kyc/add-documents) endpoint.
...
<Info>
For detailed field documentation, see the [Add Documents](https://docs.hifibridge.com/api-reference/kyc/add-documents) API reference.
</Info>
...
- [API Reference](https://docs.hifibridge.com/api-reference/kyc/add-documents) - Complete endpoint documentation