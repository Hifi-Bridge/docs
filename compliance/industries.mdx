...
## Rail-specific restrictions

<Warning>
  Certain businesses, including fintechs and licensed crypto trading platforms,
  may not allowed on the [Global Network rail](/docs/rails/global-network).
</Warning>
