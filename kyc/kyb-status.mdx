---
title: "KYB Status"
description: "To check where a business's verification stands, diagnose issues, and confirm when they're ready to use a rail, use the [KYC Status endpoint](https://docs.hifi.com/api-reference/kyc/retrieve-kyc-status). This guide focuses on interpreting the business-specific response."
---
    ...
    <ResponseField name="details" type="array[Ubo]">
      ...
      <Expandable title="UBO item">
        ...
        <ResponseField name="liveness" type="string">
          Hosted verification URL returned when the UBO must complete live
          identity checks for virtual-account enablement. Show this URL to the
          corresponding UBO; Sumsub handles the verification experience after
          they open it. See [Liveness
          Checks](/guides/liveness-checks#show-each-ubo-their-link).
        </ResponseField>
        <ResponseField name="reviewResult" type="ReviewResultObject">
