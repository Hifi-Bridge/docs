...
Use the KYC Status endpoint to check where a user's verification stands, diagnose issues, and confirm when they're ready to use fiat payment functionalities.
...
<Tabs>
  <Tab title="ACTIVE">
    User passed all compliance checks and completed bank onboarding. They can now use fiat payment functionalities.
  ...
  <Tab title="REJECTED">
    User is permanently denied. Resubmission via API is not permitted.
