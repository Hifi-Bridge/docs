...
description: "A Virtual Account is a dedicated bank account that automatically converts fiat deposits into stablecoins. When users send money to a virtual account via bank transfer, the funds are instantly converted to stablecoins and delivered to their wallet."
---
...
Create a virtual account using the [Create Virtual Account](https://docs.hifibridge.com/api-reference/virtual-account/create-a-virtual-account) endpoint.
...
<Warning>
  **USD Only:** Virtual accounts currently support USD deposits only. For other
  ...
  API](https://docs.hifibridge.com/api-reference/onramp/create-an-onramp).
</Warning>
...
Change the destination chain or currency for an existing virtual account using the [Update Virtual Account](https://docs.hifibridge.com/api-reference/virtual-account/update-a-virtual-account) endpoint.
...
Temporarily disable a virtual account to prevent new deposits using the [Deactivate Virtual Account](https://docs.hifibridge.com/api-reference/virtual-account/deactivate-a-virtual-account) endpoint.
...
<Accordion title="USDT Fees">
  ...
  <Accordion title="External Wallets">
    By default, stablecoins are sent to the user's HIFI wallet. Use the `externalWalletId` parameter to send to an external wallet address instead. The external wallet must be pre-registered via the [External Wallets API](https://docs.hifibridge.com/api-reference/external-wallet/create-external-wallet).
...
In sandbox, simulate deposits without real bank transfers using the [Simulate Deposit](https://docs.hifibridge.com/api-reference/virtual-account/simulate-a-deposit) endpoint.
...
- [API Reference](https://docs.hifibridge.com/api-reference/virtual-account/create-a-virtual-account) - Complete endpoint documentation
