...
Offramp accounts with `type: "africa"` support multiple countries with bank accounts and mobile money (momo) payments.
...
<Note>
  Check [Coverage](/docs/coverage) and [supported institutions](/docs/references/africa-institutions) for supported combinations of country, currency, and financial institution.
</Note>
