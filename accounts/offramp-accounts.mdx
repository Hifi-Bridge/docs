...
<Warning>
  **KYC Required:** Users must complete KYC verification before creating offramp
  accounts.
</Warning>
...
Africa accounts support multiple countries with bank accounts and mobile money (momo) payments.
...
- [KYC Requirements](/docs/kyc/kyc-requirements) - Understand KYC requirements
