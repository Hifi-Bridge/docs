...
2. **Create User A** - Onboard the sender and complete KYC verification
...
The sender needs a verified user account to access fiat payment capabilities and send remittances. Every user must accept HIFI's Terms of Service and complete KYC verification before they can move money between fiat and crypto.
...
4. **Submit KYC** - Submit for verification
...
Submit the KYC application using the [Submit KYC](https://docs.hifibridge.com/api-reference/kyc/submit-kyc) endpoint.
...
<ResponseField name="status" type="string">
  Overall KYC status. `ACTIVE` means the user can now onramp and offramp USD.
</ResponseField>
...
- ✅ Onboard users and complete KYC verification
