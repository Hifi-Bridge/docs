...
All API requests require authentication using API keys. This guide will walk you through requesting Dashboard access, creating API keys, and using them in your requests.
...
>
  Fill out our access request form to get started with the HIFI Dashboard
</Card>
