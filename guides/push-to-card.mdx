...
Push to card lets you convert stablecoins into fiat and deliver the funds to a recipient's card.

The flow has three steps:

<Steps>
  <Step title="Create user">
    Onboard the sender with a KYC Link so they are verified for USD offramps.
  </Step>
  <Step title="Add counterparty card">
    Create a counterparty for the recipient and add their card. HIFI tokenizes
    the card with the card provider and returns an `externalCardId`.
  </Step>
