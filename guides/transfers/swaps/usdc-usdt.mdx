...
**Info:** You can only refresh quotes while the swap is in `PENDING` status and before the quote expires.
...
**Info:** Once you accept the quote, you cannot refresh it again. Make sure you're ready to proceed with the swap.
