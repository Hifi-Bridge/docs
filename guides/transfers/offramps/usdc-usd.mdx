...
**Note:** You can only refresh quotes while the offramp is in `AWAITING_FUNDS` status and before the quote expires.
...
**Note:** Once you accept the quote, you cannot refresh it again. Make sure you're ready to proceed with the withdrawal.
