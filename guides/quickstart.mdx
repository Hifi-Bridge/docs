...
2. **KYC Process** - Complete verification to enable fiat payments
...
To move money between stablecoins and fiat currencies, users must complete KYC verification. This enables your user to:
...
✅ **KYC approved!** When status is `ACTIVE`, the user can proceed with transfers.
...
- ✅ Complete the KYC process to enable fiat payments
