---
title: "Quickstart"
description: "In this guide, you'll learn how to use the HIFI Sandbox API to simulate money movement. You'll create users, complete KYC, set up a virtual account, simulate a deposit to fund a wallet, and execute a transfer between wallets."
---
