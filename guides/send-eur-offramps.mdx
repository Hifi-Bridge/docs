...
- KYC or KYB approved for the required rail
...
Create an offramp account for the recipient's EUR bank account. For EUR SEPA payouts, set the account currency to `eur` and transfer type to `sepa`.
