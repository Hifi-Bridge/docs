---
title: "Send Money"
description: "This guide shows you how to send money - converting stablecoins (like USDC) into fiat currency (like USD) and sending it to a user's bank account."
---
