...
<ResponseField name="transferDetails.id" type="string">
  ...
  Bridge](https://docs.hifibridge.com/api-reference/cross-chain-bridge/retrieve-a-bridging-request)
  endpoint.
</ResponseField>
...
<Info>
  ...
  Bridge](https://docs.hifibridge.com/api-reference/bridge/create-a-bridge) API
  reference.
</Info>
