...
Returns are available on USD onramps, regardless of which rail funded the deposit. To test them in sandbox, see [Onramp magic values](/features/magic-values/onramp).
