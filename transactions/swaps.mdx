---
title: "Swaps"
description: "Swaps let you exchange one stablecoin for another within HIFI wallets. All swaps follow a two-step process: create the swap request, then accept it to execute the exchange."
tag: "New"
---
...
<ResponseField name="transferDetails.id" type="string">
  ...
  Swap](https://docs.hifibridge.com/api-reference/token-swap/retrieve-a-swap)
  endpoint.
</ResponseField>
...
<Info>
  ...
  Swap](https://docs.hifibridge.com/api-reference/token-swap/create-a-swap) API
  reference.
</Info>
...
Monitor swap status using the [Retrieve Swap](https://docs.hifibridge.com/api-reference/token-swap/retrieve-a-swap) endpoint.
...
Retrieve a list of all swaps associated with users under your organization using the [List Swaps](https://docs.hifibridge.com/api-reference/token-swap/list-all-swaps) endpoint. Swaps are returned sorted by creation date, with the most recent swaps appearing first.
...
- [API Reference](https://docs.hifibridge.com/api-reference/token-swap/create-a-swap) - Complete endpoint documentation
