...
Use the [Create Offramp](https://docs.hifibridge.com/api-reference/offramp/create-an-offramp) endpoint to get a quote.
...
<Info>
  ...
  Offramp](https://docs.hifibridge.com/api-reference/offramp/create-an-offramp) API reference.
</Info>

## Accepting Quotes

After reviewing the quote, accept it to execute the conversion using the [Accept Quote](https://docs.hifibridge.com/api-reference/offramp/accept-quote) endpoint.
...
Monitor offramp status using the [Retrieve Offramp](https://docs.hifibridge.com/api-reference/offramp/retrieve-an-offramp) endpoint. The response structure matches the create endpoint shown above.
